...
RUN apt-get update && apt-get -y install make git curl texlive-latex-recommended texlive-latex-extra texlive-fonts-recommended texlive-fonts-extra latexmk
